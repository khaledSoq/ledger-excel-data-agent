  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Local-first Excel data agent. Upload a workbook, ask in plain language, download a clean CSV.",
      },
      ...
      { property: "og:title", content: APP_NAME },
      {
        ...
        content: "Inspect Excel, filter with natural language, export CSV.",
      },
      ...(ogImage
        ? [
